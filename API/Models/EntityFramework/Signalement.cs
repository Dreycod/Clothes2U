...
public class Signalement
{
    ...
    //Property de navigation
    [InverseProperty(nameof(SignalementAnnonce.Signalement))]
    public virtual SignalementAnnonce? SignalementsAnnonce { get; set; }

    [InverseProperty(nameof(SignalementAvis.Signalement))]
    public virtual SignalementAvis? SignalementsAvis { get; set; }
