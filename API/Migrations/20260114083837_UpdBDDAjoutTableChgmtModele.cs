...
namespace API.Migrations
{
    ...
    public partial class UpdBDDAjoutTableChgmtModele : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "t_e_statut_commande_stacom",
                schema: "sae_clothes2u",
                columns: table => new
                {
                    stacom_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    stacom_libelle = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_e_statut_commande_stacom", x => x.stacom_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    tic_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    tic_subject = table.Column<string>(type: "text", nullable: false),
                    tic_utilisateur_id = table.Column<int>(type: "integer", nullable: false),
                    tic_date_creation = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    tic_status = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_e_ticket_tic", x => x.tic_id);
                    table.ForeignKey(
                        name: "FK_t_e_ticket_tic_t_e_utilisateur_uti_tic_utilisateur_id",
                        column: x => x.tic_utilisateur_id,
                        principalSchema: "sae_clothes2u",
                        principalTable: "t_e_utilisateur_uti",
                        principalColumn: "uti_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "t_e_ticket_message_ticmes",
                schema: "sae_clothes2u",
                columns: table => new
                {
                    ticmes_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ticmes_utilisateur_id = table.Column<int>(type: "integer", nullable: false),
                    ticmes_date_envoi = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ticmes_content = table.Column<string>(type: "text", nullable: false),
                    ticmes_ticket_id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_e_ticket_message_ticmes", x => x.ticmes_id);
                    table.ForeignKey(
                        name: "FK_t_e_ticket_message_ticmes_t_e_ticket_tic_ticmes_ticket_id",
                        column: x => x.ticmes_ticket_id,
                        principalSchema: "sae_clothes2u",
                        principalTable: "t_e_ticket_tic",
                        principalColumn: "tic_id");
                    table.ForeignKey(
                        name: "FK_t_e_ticket_message_ticmes_t_e_utilisateur_uti_ticmes_utilis~",
                        column: x => x.ticmes_utilisateur_id,
                        principalSchema: "sae_clothes2u",
                        principalTable: "t_e_utilisateur_uti",
                        principalColumn: "uti_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cmd_statut_commande_id = table.Column<int>(type: "integer", nullable: false),
                    ...
                    cmd_conversation_id = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ann_id");
                    table.ForeignKey(
                        name: "FK_Commande_Conversation",
                        column: x => x.cmd_conversation_id,
                        principalSchema: "sae_clothes2u",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.cmd_statut_commande_id,
                        principalSchema: "sae_clothes2u",
                        principalTable: "t_e_statut_commande_stacom",
                        principalColumn: "stacom_id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mespay_commande_id = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commande_MessagesPayees",
                        column: x => x.mespay_commande_id,
                        principalSchema: "sae_clothes2u",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_e_commande_cmd_cmd_conversation_id",
                schema: "sae_clothes2u",
                table: "t_e_commande_cmd",
                column: "cmd_conversation_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_e_commande_cmd_cmd_statut_commande_id",
                schema: "sae_clothes2u",
                table: "t_e_commande_cmd",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_e_message_payee_mespay_mespay_commande_id",
                schema: "sae_clothes2u",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_e_ticket_message_ticmes_ticmes_ticket_id",
                schema: "sae_clothes2u",
                table: "t_e_ticket_message_ticmes",
                column: "ticmes_ticket_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_e_ticket_message_ticmes_ticmes_utilisateur_id",
                schema: "sae_clothes2u",
                table: "t_e_ticket_message_ticmes",
                column: "ticmes_utilisateur_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_e_ticket_tic_tic_utilisateur_id",
                schema: "sae_clothes2u",
