...
{
    /// <inheritdoc />
    public partial class PrixDansConversationMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mes_categorie_id = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_j_mesure_mes", x => x.mes_id);
                    table.ForeignKey(
                        name: "FK_t_j_mesure_mes_t_e_categorie_cat_mes_categorie_id",
                        column: x => x.mes_categorie_id,
                        principalSchema: "sae_clothes2u",
                        principalTable: "t_e_categorie_cat",
                        principalColumn: "cat_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mesval_proposition_validee_id = table.Column<int>(type: "integer", nullable: false),
                    mesval_est_acceptee = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_e_message_validation_mesval", x => x.mesval_id);
                    table.ForeignKey(
                        name: "FK_t_e_message_validation_mesval_t_e_message_demande_mesdem_me~",
                        column: x => x.mesval_proposition_validee_id,
                        principalSchema: "sae_clothes2u",
                        principalTable: "t_e_message_demande_mesdem",
                        principalColumn: "mesdem_id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_e_message_validation_mesval_mesval_proposition_validee_id",
                schema: "sae_clothes2u",
                table: "t_e_message_validation_mesval",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_j_mesure_mes_mes_categorie_id",
                schema: "sae_clothes2u",
                table: "t_j_mesure_mes",
                column: "mes_categorie_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_j_mesure_mes_mes_taille_id_mes_categorie_id",
                schema: "sae_clothes2u",
                table: "t_j_mesure_mes",
                columns: new[] { "mes_taille_id", "mes_categorie_id" },
                unique: true);
