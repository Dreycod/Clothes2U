...
public class ConversationControllerTest
{
    ...
    // Utilisateurs
        ...
        {
            MessageTexteId = 1,
            ContenuMessage = "Bonjour, est-ce que le T-shirt est toujours disponible ?",
            MessageId = 1
        };
        ...
        {
            MessageTexteId = 2,
            ContenuMessage = "Oui, il est toujours disponible !",
            MessageId = 2
        };
        ...
        {
            MessageTexteId = 3,
            ContenuMessage = "Parfait ! Pourrais-je l'avoir pour 20€ ?",
            MessageId = 3
        };
        ...
        {
            MessageTexteId = 4,
            ContenuMessage = "Bonjour, je suis intéressé par les baskets. Quelle est leur pointure ?",
            MessageId = 4
        };
        ...
        {
            MessageTexteId = 5,
            ContenuMessage = "Bonjour, c'est du 42. Elles sont en excellent état !",
            MessageId = 5
        };
        ...
        {
            MessageTexteId = 6,
            ContenuMessage = "Parfait ! Je les prends à 60€. Comment procède-t-on ?",
            MessageId = 6
        };
        ...
        {
            MessageTexteId = 7,
            ContenuMessage = "Super ! On peut se rencontrer cette semaine pour l'échange.",
            MessageId = 7
        };
        ...
        {
            MessageTexteId = 8,
            ContenuMessage = "Salut ! Le T-shirt est de quelle couleur exactement ?",
            MessageId = 8
        };
        ...
        {
            MessageTexteId = 9,
            ContenuMessage = "Il est noir avec le logo blanc Nike.",
            MessageId = 9
        };
    }
